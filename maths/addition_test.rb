...
describe AdditionExpr, " as a nice class" do
    it "supports ==" do
...
describe AdditionExpr, " as a parser extension" do
    before do
...
describe AdditionExpr, " as a typesetter extension" do
    it "typesets additions like their to_s"
end

describe AdditionExpr, " as a transform extension" do
